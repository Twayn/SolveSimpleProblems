...
class PermutationsFinderTest {
    ...
    @Test
    void findPermutationsOfAll() {
        final List<char[]> actual = finder.findPermutations(new char[]{'a', 'b', 'c'});
    ...
    void findPermutationsForDouble() {
        final List<char[]> actual = finder.findPermutations(new char[]{'a', 'b'});
    ...
    void findPermutationsForSingle() {
        final List<char[]> actual = finder.findPermutations(new char[]{'a'});
